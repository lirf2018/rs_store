    ...
    <div id="main">
        <div class="warp clearfloat">
            <div class="cashlist clearfloat">
                <c:if test="${result=='success-register'}">
                    <ul>
                        <li class="box-s">
                            <div class="ui-input-text"><span>注册成功</span></div>
                        </li>
                ...
                <c:if test="${result=='fail-register'}">
                    <ul>
                        <li class="box-s">
                            <div class="ui-input-text"><span>注册失败</span></div>
                        </li>
                        <li class="box-s">
                ...
                <c:if test="${result=='success-reset'}">
                    <ul>
                        <li class="box-s">
                            <div class="ui-input-text"><span>重置成功</span></div>
                        </li>
                        <li class="box-s box-s-sure-btn">
                            <div class="sure-btn">
                                <span>返回登录页</span>
                ...
                <c:if test="${result=='fail-reset'}">
                    <ul>
                        <li class="box-s">
                            <div class="ui-input-text"><span>重置失败</span></div>
                        </li>
                        <li class="box-s">
                            <span style="font-size: 14px;color: red;">失败原因:${desc}</span>
                        </li>
