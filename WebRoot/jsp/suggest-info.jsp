    ...
    <div id="main">
        <div class="warp clearfloat">
            <div class="cashlist clearfloat">
                <ul>
                    <li class="box-s">
                        <p class="fl">${data.complain_info.information}</p>
                        <c:choose>
                            <c:when test="${data.complain_info.is_read==1}">
            ...
            <div class="cashlist clearfloat">
                <ul>
                    <div class="suggest-info">
                        <div class="suggest-info-time">${data.complain_info.createtime}</div>
                    </div>
                </ul>
            </div>
        </div>
