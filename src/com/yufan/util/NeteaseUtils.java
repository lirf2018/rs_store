...
public class NeteaseUtils {
    ...
    private final static String APP_SECRET = ConfigProperty.getConfigValue("app_secret_netease");//开发者平台分配的appkey
    private final static String APP_KEY = ConfigProperty.getConfigValue("app_secret_key");//开发者平台分配的appkey

    private final static String SENDTEMPLATE_URL = ConfigProperty.getConfigValue("sendtemplate_netease");
    private final static String SENDCODE_URL = ConfigProperty.getConfigValue("sendcode_netease");
    ...
    public static JSONObject sendcode(JSONObject inObj) {
        ...
        try {
            ...
            //发送验证码
            String result = HttpUtil.httpPostNetease(nvps, SENDCODE_URL, APP_SECRET, APP_KEY);
    ...
    public static JSONObject sendtemplate(JSONObject inObj) {
        ...
        try {
            ...
            nvps.add(new BasicNameValuePair("needUp", String.valueOf(needUp)));
            //发送验证码
            String result = HttpUtil.httpPostNetease(nvps, SENDTEMPLATE_URL, APP_SECRET, APP_KEY);
