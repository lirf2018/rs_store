...
public class WeixinDevUtils {
    ...
    public String getAccessToken() {
        try {
            String url = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=" + RsConstants.WX_APPID + "&secret=" + RsConstants.WX_SECRET + "&grant_type=client_credential";
    ...
    public JSONObject getOpenId2Json(String code) {
        ...
        String url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=" + RsConstants.WX_APPID + "&secret=" + RsConstants.WX_SECRET + "&code=" + code + "&grant_type=authorization_code";
