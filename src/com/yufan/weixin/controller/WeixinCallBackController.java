package com.yufan.weixin.controller;

import com.alibaba.fastjson.JSONObject;
import com.yufan.util.Sha1Util;
import com.yufan.weixin.util.XmlConverJsonUtil;
import com.yufan.weixin.weixin.WeixinDevUtils;
import com.yufan.weixin.weixin.WeixinInformation;
import com.yufan.weixin.weixin.bean.msg.RequestMessage;
...
public class WeixinCallBackController {
    ...
    /**
     * 获取openId
     * http://v17022b547.51mypc.cn/rs_store/weixin/openid
     */
    @RequestMapping("openid")
    public void weixinCallBackAction_getOpenId(HttpServletRequest request, HttpServletResponse response) {
        try {
            //注意，访问的域名地址要和平台获取用户基本信息设置的要一致
...
//            System.out.println(url);
     ...
     * http://v17022b547.51mypc.cn/weixin/access
     * 微信平台接入，只能使用80端口
     * 请填写接口配置信息，此信息需要你有自己的服务器资源，填写的URL需要正确响应微信发送的Token验证，请阅读消息接口使用指南。
     */
    @RequestMapping("access")
    public void weixinCallBackAction_access(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("------------------------验证URL真实性------------------------");
        access(request, response);//认证
    }


    public void weixinCallBackAction(HttpServletRequest request, HttpServletResponse response) {
...
//            //被动回复
    ...
    public static void main(String[] args) throws Exception {
        String redirect_uri = "http://lrf-13418915218.6655.la:26761/weixin/weixin-login";
//        String scope = "snsapi_base";//静默获取
        String scope = "snsapi_userinfo";//用户有感知
        String redirect_uri_u = URLEncoder.encode(redirect_uri, "utf-8");
        String url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx0bdabad84b781956&redirect_uri=" + redirect_uri_u + "&response_type=code&scope=" + scope + "&state=STATE#wechat_redirect";
